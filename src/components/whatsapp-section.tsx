export function WhatsAppSection() {
  const BENEFITS = [
    "Connects via official Meta Cloud API — no third-party middleware",
    "Answers based on your exact documents — no hallucinations",
    "Escalates to a human agent when needed",
    "Responds in Portuguese, English, or Spanish",
    "Available 24/7, including weekends and holidays",
    "Works alongside your existing WhatsApp Business number",
  ];
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6">
        ...
        <div className="flex justify-center mb-10">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#25D366]/30 bg-[#25D366]/10 px-4 py-1.5 text-sm font-semibold text-[#25D366] animate-on-scroll">
            ...
            Only on Foji — not available on Chatbase, DocsBot, or CustomGPT
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 animate-on-scroll">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              In Brazil, WhatsApp is the #1 channel for business communication. Your customers already expect to reach you there. With Foji, your AI is ready to answer them — trained on your documents, running 24 hours a day.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              No extra app. No chatbot builder. No developer required. Connect your existing WhatsApp Business number and your AI handles the rest.
            </p>
