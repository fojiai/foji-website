const STEPS = [
  {
    ...
    description:
      "Choose an industry template or write your own system prompt. Name your agent, set its tone, and define the scope of what it knows. Takes about 2 minutes.",
    visual: (
      <div className="rounded-xl border border-border bg-muted/30 p-4 space-y-3">
        ...
        <div className="flex gap-2">
          ...
          <div className="h-8 px-3 rounded-lg bg-muted flex items-center text-xs text-muted-foreground">HR & Internal</div>
        </div>
      </div>
    ),
  },
  {
    ...
    description:
      "Upload PDFs, Word docs, spreadsheets, or presentations. Foji extracts and indexes everything automatically. Your AI learns from your actual content — not generic internet data. Your documents are never used to train third-party AI models.",
    visual: (
      <div className="rounded-xl border border-border bg-muted/30 p-4 space-y-2">
        ...
        <p className="text-xs text-muted-foreground/60 text-center pt-1">Your data stays private. Never shared with third parties.</p>
      </div>
    ),
  },
  {
    ...
    description:
      "Copy a single script tag and paste it into your website. Done. Or activate WhatsApp and start receiving AI replies in your existing WhatsApp Business number. Either way, you're live in seconds.",
    visual: (
      <div className="rounded-xl border border-border bg-muted/30 p-4 space-y-3">
        ...
        <p className="text-xs text-muted-foreground text-center">Seriously. That&apos;s the whole deployment.</p>
        <div className="flex items-center gap-2 rounded-lg bg-[#075E54]/20 border border-[#075E54]/30 px-3 py-2">
          ...
          <p className="text-xs text-[#25D366]/90 font-medium">Or connect your WhatsApp Business number instead.</p>
        </div>
      </div>
    ),
  },
