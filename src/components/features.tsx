const FEATURES = [
  {
    ...
    title: "Native WhatsApp Support",
    description:
      "Turn your WhatsApp Business number into an AI support channel. Customers message you — the AI responds instantly, 24/7, trained on your actual documents.",
    highlight: true,
  },
  {
    icon: (
    ...
    title: "Your Docs Become Its Brain",
    description:
      "Upload PDFs, Word docs, spreadsheets, or presentations. Foji extracts, normalizes, and indexes everything so your AI answers from your actual content — not generic internet data.",
  },
  {
    icon: (
    ...
    title: "On Your Site in 60 Seconds",
    description:
      "One <script> tag. No developer needed, no plugin to install. The chat widget loads in a Shadow DOM so it never breaks your existing site design.",
  },
  {
    icon: (
    ...
    description:
      "Your agent doesn't guess — it answers based on your documents. No hallucinations about policies you don't have. Powered by OpenAI, Google Gemini, and AWS Bedrock.",
  },
  {
    icon: (
    ...
    description:
      "Responds in Portuguese, English, or Spanish. Built natively for the Brazilian market with LGPD compliance — and ready for international customers too.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>
    ),
    title: "See What Your Customers Ask",
    description:
      "Every conversation logged and analyzed. Spot the questions you keep getting — and use them to improve your agent or fill gaps in your documentation.",
  },
];
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight animate-on-scroll">
            From PDF to AI-Powered Support — in Under 5 Minutes
          </h2>
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto animate-on-scroll animate-delay-100">
            Everything you need to stop answering the same questions manually.
          </p>
        </div>
